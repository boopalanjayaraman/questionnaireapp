...
class HorizontalTableSubSection extends Component{
                ...
                <div className="container">
                    <TableContainer>
                        <Table className={classes.table} >
                                <TableHead>
                                    <TableRow key={'horitable_headrow_'}>
...
export default withStyles(styles)(HorizontalTableSubSection);